...
from newcode.mcp_.async_lifecycle import (
...
class TestGlobalLifecycleManager:
    ...
    def test_get_lifecycle_manager_returns_instance(self):
        ...
        with patch("newcode.mcp_.async_lifecycle._lifecycle_manager", None):
    ...
    def test_get_lifecycle_manager_singleton(self):
        ...
        # Reset the global
        import newcode.mcp_.async_lifecycle as lifecycle_module
