...
from newcode.mcp_.health_monitor import (
    HealthCheckResult,
    HealthMonitor,
    HealthStatus,
)
from newcode.mcp_.managed_server import ManagedMCPServer
...
class TestHealthMonitor:
    ...
    async def test_start_stop_monitoring(self, health_monitor, mock_server):
        ...
        with patch("newcode.mcp_.health_monitor.logger") as mock_logger:
            await health_monitor.start_monitoring(server_id, mock_server)
