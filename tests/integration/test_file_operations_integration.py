...
def test_file_operations_integration(
    ...
    edit_prompt = f"Use edit_file to add a new line to {test_dir}/simple.txt that says 'Updated by agent!'"
    ...
    _retry_file_edit_with_content_check(
        cli_harness, result, test_dir, "simple.txt", "Updated by agent!"
    )
