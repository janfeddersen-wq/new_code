"""Tests for newcode.plugins package __init__.py.
...
class TestLoadPluginCallbacks:
    ...
    def test_load_plugin_callbacks_callable(self):
        ...
        from newcode.plugins import load_plugin_callbacks
    ...
    def test_import_error_is_caught(self, mock_import):
        ...
        with patch("newcode.plugins.Path") as mock_path_class:
    ...
    def test_skips_non_directory_items(self):
        ...
        with patch("newcode.plugins.Path") as mock_path_class:
            ...
            with patch("newcode.plugins.importlib.import_module") as mock_import:
                # Call the function
                load_plugin_callbacks()
