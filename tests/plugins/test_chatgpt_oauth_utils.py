...
class TestTokenStorage:
    ...
    @patch("newcode.plugins.chatgpt_oauth.utils.get_token_storage_path")
...
class TestAddModelsToConfig:
    ...
    @patch("newcode.plugins.chatgpt_oauth.utils.save_chatgpt_models")
    @patch("newcode.plugins.chatgpt_oauth.utils.load_chatgpt_models")
