...
class TestStatusCommand:
    def test_generates_group_id(self, status_cmd):
        with (
            patch("newcode.command_line.mcp.list_command.emit_info"),
            patch("newcode.command_line.mcp.status_command.emit_info"),
        ):
    ...
    def test_no_args_delegates_to_list(self, status_cmd):
        with (
            patch("newcode.command_line.mcp.list_command.emit_info") as mock_list_emit,
            patch("newcode.command_line.mcp.status_command.emit_info"),
        ):
            status_cmd.manager.list_servers.return_value = []
    ...
    def test_server_not_found(self, status_cmd):
        with (
            ...
            patch("newcode.command_line.mcp.status_command.suggest_similar_servers"),
            patch("newcode.command_line.mcp.status_command.emit_info") as mock_emit,
        ):
    ...
    def test_detailed_status_basic(self, status_cmd):
        ...
        with (
            ...
            patch("newcode.command_line.mcp.status_command.emit_info") as mock_emit,
            patch("newcode.command_line.mcp.status_command.emit_error"),
            patch("newcode.mcp_.async_lifecycle.get_lifecycle_manager") as mock_lm,
        ):
    ...
    def test_detailed_status_exception(self, status_cmd):
        ...
        with (
            ...
            patch("newcode.command_line.mcp.status_command.emit_info"),
            patch("newcode.command_line.mcp.status_command.emit_error") as mock_err,
        ):
            status_cmd.execute(["myserver"], group_id="g1")
