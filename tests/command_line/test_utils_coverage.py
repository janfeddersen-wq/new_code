"""Additional coverage tests for newcode.command_line.utils.
...
class TestResetWindowsConsole:
    ...
    def test_returns_early_on_non_windows(self):
        ...
        from newcode.command_line.utils import _reset_windows_console
...
class TestSafeInput:
    ...
    def test_calls_reset_windows_console(self):
        ...
        from newcode.command_line.utils import safe_input

        with patch("newcode.command_line.utils._reset_windows_console") as mock_reset:
    ...
    def test_returns_stripped_input(self):
        ...
        with patch("newcode.command_line.utils._reset_windows_console"):
