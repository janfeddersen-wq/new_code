"""Full coverage tests for newcode/tools/common.py.
...
class TestShouldSuppressBrowser:
    def test_headless_true(self, monkeypatch):
        ...
        from newcode.tools.common import should_suppress_browser
...
class TestShouldIgnorePath:
    def test_git_directory(self):
        from newcode.tools.common import should_ignore_path
...
class TestShouldIgnoreDirPath:
    def test_git_dir(self):
        from newcode.tools.common import should_ignore_dir_path
...
class TestGetLexerForExtension:
    def test_python_extension(self):
        from newcode.tools.common import _get_lexer_for_extension
    ...
    def test_no_pygments(self):
        import newcode.tools.common as mod
    ...
    def test_get_lexer_by_name_exception(self):
        ...
        from newcode.tools.common import PYGMENTS_AVAILABLE, _get_lexer_for_extension

        if not PYGMENTS_AVAILABLE:
            pytest.skip("Pygments not available")
        with patch(
            "newcode.tools.common.get_lexer_by_name",
...
class TestGetTokenColor:
    def test_returns_default_for_unknown(self):
        from newcode.tools.common import _get_token_color
    ...
    def test_keyword_token(self):
        from newcode.tools.common import PYGMENTS_AVAILABLE, _get_token_color
...
class TestHighlightCodeLine:
    ...
    def test_with_lexer_none(self):
        from newcode.tools.common import _highlight_code_line
...
class TestExtractFileExtensionFromDiff:
    def test_with_python_file(self):
        from newcode.tools.common import _extract_file_extension_from_diff
...
class TestBrightenHex:
    def test_no_change(self):
        from newcode.tools.common import brighten_hex
...
class TestFormatDiffWithSyntaxHighlighting:
    def test_basic_diff(self):
        from newcode.tools.common import _format_diff_with_syntax_highlighting
...
class TestFormatDiffWithColors:
    def test_empty_diff(self):
        from newcode.tools.common import format_diff_with_colors
...
class TestFindBestWindow:
    def test_exact_match(self):
        from newcode.tools.common import _find_best_window
...
class TestArrowSelectAsync:
    ...
    async def test_basic_selection(self):
        ...
        with patch("newcode.tools.common.Application") as MockApp:
            ...
            with patch("newcode.tools.common.arrow_select_async") as mock_sel:
...
class TestArrowSelect:
    def test_raises_in_async_context(self):
        ...
        from newcode.tools.common import arrow_select
...
class TestGetUserApproval:
    def test_approve(self):
        ...
        with patch("newcode.tools.common.arrow_select", return_value="✓ Approve"):
            with patch("newcode.tools.common.Console"):
    ...
    def test_reject(self):
        ...
        with patch("newcode.tools.common.arrow_select", return_value="✗ Reject"):
            with patch("newcode.tools.common.Console"):
                with patch("newcode.tools.command_runner.set_awaiting_user_input"):
                    with patch("newcode.tools.common.emit_info"):
                        with patch("newcode.tools.common.emit_error"):
                            confirmed, feedback = get_user_approval(
                                "Test", "content", agent_name="Biscuit"
                            )
    ...
    def test_reject_with_feedback(self):
        ...
        with patch(
            "newcode.tools.common.arrow_select",
            return_value="💬 Reject with feedback (tell Biscuit what to change)",
        ):
            with patch("newcode.tools.common.Prompt") as MockPrompt:
                MockPrompt.ask.return_value = "fix the thing"
                with patch("newcode.tools.common.Console"):
                    with patch("newcode.tools.command_runner.set_awaiting_user_input"):
                        with patch("newcode.tools.common.emit_info"):
                            with patch("newcode.tools.common.emit_error"):
                                with patch("newcode.tools.common.emit_warning"):
                                    confirmed, feedback = get_user_approval(
                                        "Test", "content", agent_name="Biscuit"
                                    )
        assert confirmed is False
    ...
    def test_reject_with_empty_feedback(self):
        ...
        with patch("newcode.tools.common.arrow_select", return_value="💬 feedback"):
            with patch("newcode.tools.common.Prompt") as MockPrompt:
    ...
    def test_keyboard_interrupt(self):
        ...
        with patch("newcode.tools.common.arrow_select", side_effect=KeyboardInterrupt):
            with patch("newcode.tools.common.Console"):
                with patch("newcode.tools.command_runner.set_awaiting_user_input"):
                    with patch("newcode.tools.common.emit_info"):
                        with patch("newcode.tools.common.emit_error"):
    ...
    def test_eof_error(self):
        ...
        with patch("newcode.tools.common.arrow_select", side_effect=EOFError):
            with patch("newcode.tools.common.Console"):
                with patch("newcode.tools.command_runner.set_awaiting_user_input"):
                    with patch("newcode.tools.common.emit_info"):
                        with patch("newcode.tools.common.emit_error"):
...
class TestModuleConstants:
    def test_extension_to_lexer_name(self):
        from newcode.tools.common import EXTENSION_TO_LEXER_NAME

        assert ".py" in EXTENSION_TO_LEXER_NAME
        assert EXTENSION_TO_LEXER_NAME[".py"] == "python"

    def test_token_colors_dict(self):
        from newcode.tools.common import PYGMENTS_AVAILABLE, TOKEN_COLORS
