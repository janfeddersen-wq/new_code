...
class TestAgentManagerErrors:
    ...
    def test_load_agent_invalid_name(self, mock_discover):
        ...
        with patch("newcode.agents.agent_manager._AGENT_REGISTRY", {}):
            with pytest.raises(
    ...
    def test_load_agent_fallback_behavior(self, mock_discover):
        ...
        with patch(
            "newcode.agents.agent_manager._AGENT_REGISTRY",
    ...
    def test_load_agent_corrupted_registry_entry(self, mock_discover):
        ...
        with patch(
            "newcode.agents.agent_manager._AGENT_REGISTRY", {"bad-agent": 12345}
        ):
    ...
    @patch("newcode.agents.agent_manager._CURRENT_AGENT", None)
