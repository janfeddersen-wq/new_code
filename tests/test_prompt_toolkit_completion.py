...
def test_set_completer_no_match(monkeypatch):
    monkeypatch.setattr("newcode.config.get_config_keys", lambda: ["actual_key"])
    completer = SetCompleter()
...
@pytest.mark.asyncio
@patch("newcode.command_line.prompt_toolkit_completion.PromptSession")
@patch("newcode.command_line.prompt_toolkit_completion.FileHistory")
@patch("newcode.command_line.prompt_toolkit_completion.merge_completers")
...
@pytest.mark.asyncio
@patch("newcode.command_line.prompt_toolkit_completion.PromptSession")
@patch("newcode.command_line.prompt_toolkit_completion.SafeFileHistory")
