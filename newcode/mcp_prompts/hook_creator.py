...
before user prompts for creating hooks.
"""

HOOK_CREATION_PROMPT = """
# Creating Hooks

You are helping a user create hooks. The application has two hook systems:
...
Configure shell commands responding to application events in `.claude/settings.json`:
