...
.newcode.mcp.manager to avoid circular imports with the package __init__.py
"""
...
from newcode.mcp_.manager import ServerConfig, get_mcp_manager
...
def run_add_wizard(group_id: str = None) -> bool:
    ...
    if config:
        try:
            ...
            from newcode.config import MCP_SERVERS_FILE
