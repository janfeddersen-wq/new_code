...
from newcode.gemini_model import GeminiModel
...
def _load_plugin_model_providers():
    ...
    try:
        from newcode.callbacks import on_register_model_providers
...
def make_model_settings(
    ...
    if "gpt-5" in model_name:
        ...
        from newcode.model_utils import get_default_extended_thinking
...
class ModelFactory:
    ...
    def load_config() -> Dict[str, Any]:
        ...
        try:
            from newcode.callbacks import on_load_models_config
    ...
    def get_model(model_name: str, config: Dict[str, Any]) -> Any:
        ...
        if model_type == "gemini":
            ...
            from newcode.config import get_effective_model_settings
        ...
        # via the register_model_type callback. See plugins/antigravity_oauth/register_callbacks.py
            ...
            headers["X-Cerebras-3rd-Party-Integration"] = "newcode"
            ...
            try:
                ...
                try:
                    ...
                    from newcode.plugins.gemini_oauth.config import (
                        GEMINI_OAUTH_CONFIG,
                    )
                    from newcode.plugins.gemini_oauth.utils import (
                        get_project_id,
                        get_valid_access_token,
                    )
            ...
            from newcode.gemini_code_assist import GeminiCodeAssistModel
