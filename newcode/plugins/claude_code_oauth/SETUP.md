...
5. Tokens are stored locally at `~/.newcode/claude_code_oauth.json`
...
- Models appear in `~/.newcode/extra_models.json` with the `claude-code-` prefix
...
```bash
python newcode/plugins/claude_code_oauth/test_plugin.py
```
