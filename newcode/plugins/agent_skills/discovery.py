...
from newcode.plugins.agent_skills.config import get_skill_directories
...
def get_default_skill_directories() -> List[Path]:
    ...
    Returns:
        - ~/.newcode/skills (user skills)
        - ./.newcode/skills (project config skills)
        - ./skills (project skills)
    """
    return [
        Path.home() / ".newcode" / "skills",
        Path.cwd() / ".newcode" / "skills",
        Path.cwd() / "skills",
    ]
