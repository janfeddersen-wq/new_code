...
from newcode.config import get_value, set_value
...
def get_skill_directories() -> List[str]:
    ...
    Returns:
        ...
        Default: ['~/.newcode/skills', './.newcode/skills', './skills']
    ...
    home_skills = str(Path.home() / ".newcode" / "skills")
    project_config_skills = str(Path.cwd() / ".newcode" / "skills")
