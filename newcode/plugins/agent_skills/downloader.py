...
from newcode.plugins.agent_skills.discovery import refresh_skill_cache
from newcode.plugins.agent_skills.installer import InstallResult

logger = logging.getLogger(__name__)

_DEFAULT_SKILLS_DIR = Path.home() / ".newcode" / "skills"
...
def download_and_install_skill(
    ...
    Args:
        ...
        target_dir: Base skills directory. Defaults to ~/.newcode/skills.
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="newcode_skill_") as tmp:
            tmp_dir = Path(tmp)
