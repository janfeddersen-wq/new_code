...
Integrates the hook engine with newcode's callback system.
"""
...
from newcode.hook_engine import EventData, HookEngine
...
async def on_startup_hook() -> None:
    """Startup callback — fires SessionStart hooks when newcode boots."""
    if not _hook_engine:
        return
