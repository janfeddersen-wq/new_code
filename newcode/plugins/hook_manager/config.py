...
Supports:
- Global hooks: ~/.newcode/hooks.json
...
_GLOBAL_HOOKS_FILE = os.path.expanduser("~/.newcode/hooks.json")
...
def _load_global_hooks_config() -> Dict[str, Any]:
    """Load hooks from ~/.newcode/hooks.json."""
...
def save_global_hooks_config(hooks: Dict[str, Any]) -> Path:
    """Persist hooks config to ~/.newcode/hooks.json.
