...
> For **built-in commands**, see the built-in command files in `newcode/command_line/`.
...
- Located in `newcode/command_line/core_commands.py`, `session_commands.py`, `config_commands.py`
...
```
newcode/plugins/example_custom_command/
...
```bash
mkdir -p newcode/plugins/my_plugin
touch newcode/plugins/my_plugin/__init__.py
touch newcode/plugins/my_plugin/register_callbacks.py
```

### Step 2: Implement Callbacks

```python
# newcode/plugins/my_plugin/register_callbacks.py
...
from newcode.plugins.my_plugin.register_callbacks import _handle_custom_command
...
- `newcode/callbacks.py` - Callback system implementation
- `newcode/command_line/command_handler.py` - Command dispatcher
- `newcode/command_line/core_commands.py` - Example built-in commands
- `newcode/command_line/command_registry.py` - Registry system
