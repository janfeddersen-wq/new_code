...
def register_scheduler_list_tasks(agent):
    ...
    def scheduler_list_tasks() -> str:
        ...
        """
        from newcode.scheduler import load_tasks
        from newcode.scheduler.daemon import get_daemon_pid
...
def register_scheduler_create_task(agent):
    ...
    def scheduler_create_task(
        ...
        """
        from newcode.scheduler import ScheduledTask, add_task
        from newcode.scheduler.daemon import get_daemon_pid
...
def register_scheduler_delete_task(agent):
    ...
    def scheduler_delete_task(
        ...
        """
        from newcode.scheduler import delete_task, get_task
...
def register_scheduler_toggle_task(agent):
    ...
    def scheduler_toggle_task(
        ...
        """
        from newcode.scheduler import get_task, toggle_task
...
def register_scheduler_start_daemon(agent):
    ...
    def scheduler_start_daemon() -> str:
        ...
        """
        from newcode.scheduler.daemon import get_daemon_pid, start_daemon_background
...
def register_scheduler_stop_daemon(agent):
    ...
    def scheduler_stop_daemon() -> str:
        ...
        """
        from newcode.scheduler.daemon import get_daemon_pid, stop_daemon
...
def register_scheduler_run_task(agent):
    ...
    def scheduler_run_task(
        ...
        """
        from newcode.scheduler import get_task
        from newcode.scheduler.executor import run_task_by_id
