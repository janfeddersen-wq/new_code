...
from newcode.callbacks import on_delete_file, on_edit_file
...
from newcode.tools.common import _find_best_window, generate_group_id
...
def _delete_snippet_from_file(
    ...
    try:
        ...
        from newcode.config import get_diff_context_lines
...
def delete_snippet_from_file(
    ...
    from newcode.callbacks import on_file_permission
