...
# ---------------------------------------------------------------------------
from newcode.messaging import (  # New structured messaging types
    FileContentMessage,
    FileEntry,
    FileListingMessage,
    GrepMatch,
...
def _grep(context: RunContext, search_string: str, directory: str = ".") -> GrepOutput:
    ...
    try:
        ...
        # Add ignore patterns to the command via a temporary file
        from newcode.tools.common import DIR_IGNORE_PATTERNS
...
def register_list_files(agent):
    ...
    from newcode.config import get_allow_recursion
