...
async def list_config() -> Dict[str, Any]:
    ...
    from newcode.config import get_config_keys, get_value
...
async def set_config_value(key: str, update: ConfigUpdate) -> ConfigValue:
    ...
    from newcode.config import get_config_keys, get_value, set_value
...
async def reset_config_value(key: str) -> Dict[str, str]:
    ...
    from newcode.config import reset_value
