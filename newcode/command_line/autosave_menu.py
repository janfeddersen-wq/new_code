...
from newcode.config import AUTOSAVE_DIR
from newcode.session_storage import list_sessions, load_session
...
def display_resumed_history(
    ...
    from newcode.config import get_banner_color, get_resume_message_count
