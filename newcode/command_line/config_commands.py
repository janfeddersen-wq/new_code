...
from newcode.config import get_config_keys
...
def get_commands_help():
    ...
    from newcode.command_line.command_handler import get_commands_help as _gch
...
def handle_reasoning_command(command: str) -> bool:
    ...
    from newcode.messaging import emit_error, emit_success, emit_warning
    ...
    effort = tokens[1]
    try:
        from newcode.config import set_openai_reasoning_effort
    ...
    from newcode.config import get_openai_reasoning_effort
...
def handle_verbosity_command(command: str) -> bool:
    ...
    verbosity = tokens[1]
    try:
        from newcode.config import set_openai_verbosity
    ...
    from newcode.config import get_openai_verbosity
...
def handle_pin_model_command(command: str) -> bool:
    ...
    try:
        if is_json_agent:
            ...
            from newcode.config import set_agent_pinned_model
...
def handle_unpin_command(command: str) -> bool:
    ...
    from newcode.agents.json_agent import discover_json_agents
    from newcode.config import get_agent_pinned_model
    from newcode.messaging import emit_error, emit_info, emit_success, emit_warning
    ...
    try:
        if is_json_agent:
            ...
            from newcode.config import clear_agent_pinned_model
...
def handle_diff_command(command: str) -> bool:
    ...
    from newcode.command_line.diff_menu import interactive_diff_picker
    from newcode.config import (
...
def handle_colors_command(command: str) -> bool:
    ...
    from newcode.command_line.colors_menu import interactive_colors_picker
    from newcode.config import set_banner_color
    from newcode.messaging import emit_error, emit_success
