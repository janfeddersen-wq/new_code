...
def handle_mcp_command(command: str) -> bool:
    ...
    from newcode.command_line.mcp import MCPCommandHandler
...
def handle_wiggum_command(command: str) -> str | bool:
    ...
    """
    from newcode.command_line.wiggum_state import start_wiggum
    from newcode.messaging import emit_info, emit_success, emit_warning
...
def handle_wiggum_stop_command(command: str) -> bool:
    ...
    from newcode.command_line.wiggum_state import is_wiggum_active, stop_wiggum
