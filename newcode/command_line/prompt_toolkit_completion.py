...
from newcode.command_line.command_registry import get_unique_commands
...
from newcode.command_line.pin_command_completion import PinCompleter, UnpinCompleter
