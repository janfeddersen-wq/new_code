...
from newcode.config import EXTRA_MODELS_FILE, set_config_value
from newcode.messaging import emit_error, emit_info, emit_warning
from newcode.models_dev_parser import ModelInfo, ModelsDevRegistry, ProviderInfo
...
class AddModelMenu:
    ...
    def run(self) -> bool:
        ...
        try:
            ...
            # This is needed because newcode runs in an async context
